  ...
  <section id="appointment" class="appointment section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Check Your Urine R/ME Report</h2>
        ...
        <form action="" method="post">
            ...
            <div class="col-md-6 offset-3 form-group">
              <label for="inputEmailAddress">color</label>
            ...
            <div class="col-md-6 offset-3 form-group">
              <label for="inputEmailAddress">apprnc</label>
            ...
            <div class="col-md-6 offset-3 form-group">
              <label for="inputEmailAddress">gravity</label>
            ...
            <div class="col-md-6 offset-3 form-group">
              <label for="inputEmailAddress">nitrt</label>
