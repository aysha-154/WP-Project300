  ...
  <main id="main">
    ...
    <section id="login" class="contact">
      ...
      <div class="container">
          ...
          <div class="col-md-8 col-xs-8 offset-2">
            ...
            <form action="" method="post" class="card-body" >
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 form-group">
                                      ...
                                      <input type="text" name="password" class="form-control" value="<?=set_value('password')?>" placeholder="Your Password" id="password">
                                      <div class="error"><?=form_error('password')?></div>
                                    </div>
                                    <div class="col-sm-12 text-center">
                                        <button type="submit" class="color btn btn-default">Login</button>
                                    </div>
                                </div>
                                <!-- /.row -->
                            </form>
                            ...
                            <div class="text-center">
                                <p>Don't have any account? <a class="" href="<?=base_url()?>Login/signup">Sign Up Now</a> </p>
                            </div>
                            <style type="text/css"> 
                            .color{
                              background: #3fbbc0;
